...
TREF = 296.0 #Temp ref
K_B_erg = 1.380649e-16 # Boltzmann constant in erg/K     JL:how we can remove that units?
C_M_S   = 299792458.0 # Speed of light in m/s
C_CM_S  = C_M_S * 100.0 # Speed of light in cm/s
C2      = 1.43880285 #h*c/kB in cm·K       JL: hc/k - h:planck, c:speed of light, k:boltzmann
...
class Isotopologue: # Minimal configuration per isotopologue
    iso: str    # name of the isotopologues
    qfile: str  # q file of the isotopologues
    Wg: float   # molar weight
    Pmol: float | None = None  # molar fraction 
...
# Isotopologues Method 1:
# JL: I should understand that method
...
# Isotopologues Method 2:
# JL: Bank of the isotopologues of all species
def _isotopologue_bank(base: str = "/home/jleon13/Documents/AFOSR project/Py4catsForward/forwardOscar/Stand-off/TIPS/") -> Dict[str, Dict[str, Any]]:
...
# JL: study really deeply that method!
def downsample(simulated_dir, gt_dir, output_dir):

    # JL: understand that part, is do it in based of equations? which equations?
...
def run_simulation(
    ...
    parfile: str = '/home/jleon13/Documents/AFOSR project/Py4catsForward/Py4cats_Tinkering/680HIT87b.par',
    nu_min: float = 666.67,
